...
contract SafeHouse is Context, IERC20, Ownable {
    ...
    // ********************************* START VARIABLES **********************************
    string private _name = "SafeHouse";                                                  // name
    string private _symbol = "SFH";                                                      // symbol
    uint256 private _tTotal = 1000000000000000 * 10**uint256(_decimals);                 // total supply
    uint256 public _taxFee = 5;                                                          // % to holders
    ...
    address[] public  pancakeRouterAddresses = [                                         // 
        0x10ED43C718714eb63d5aA57B78B54704E256024E,                                      // Pancake Router Version 2 address (mainnet)
        0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3                                       // Pancake Router Version 2 address (testnet)
    ];                                                                                   //
    ...
    constructor (uint net) public {
        _rOwned[_msgSender()] = _rTotal;
        
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(pancakeRouterAddresses[net]);
